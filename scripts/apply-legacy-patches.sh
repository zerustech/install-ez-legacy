...
patch -p1 < $prefix/patches/config-config_dev.yml.1.patch
...
patch -p1 < $prefix/patches/config-ezpublish.yml.2.patch
...
patch -p1 < $prefix/patches/legacy-bridge-twigcontentviewlayoutdecorator.php.2.patch
